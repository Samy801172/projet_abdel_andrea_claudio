...
var AppController = (function () {
  ...
  var AppController = (_classThis = /** @class */ (function () {
    ...
    AppController_1.prototype.getHello = function () {
      return {
        result: true,
        code: common_2.ApiCodeResponse.TEST,
        date: this.appService.getHello(),
      };
    };
  ...
  (function () {
    ...
    _getHello2_decorators = [
      (0, swagger_1.ApiOperation)(app_swagger_1.AppControllerHelloWorld2),
      (0, common_1.Post)('hello2'),
    ];
    __esDecorate(
      _classThis,
      null,
    ...
    __esDecorate(
      ...
      _getHello2_decorators,
      {
        ...
        access: {
          has: function (obj) {
            return 'getHello2' in obj;
          },
          get: function (obj) {
            return obj.getHello2;
          },
        },
        metadata: _metadata,
      },
