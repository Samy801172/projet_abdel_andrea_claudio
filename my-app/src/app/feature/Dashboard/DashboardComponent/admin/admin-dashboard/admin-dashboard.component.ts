    ...
    <div class="admin-layout">
      ...
      <nav class="sidebar">
        ...
        <ul class="nav-links">
          ...
          <li><a routerLink="custom-meds" routerLinkActive="active">Préparations</a></li>
          <li><a routerLink="orders" routerLinkActive="active">Commandes</a></li>
          <li><a routerLink="manufacturing" routerLinkActive="active">
            <i class="fas fa-flask"></i> Fabrication
          </a></li>
